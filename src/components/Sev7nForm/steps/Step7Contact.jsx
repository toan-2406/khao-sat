  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div className="fg">
        ...
        <RadioGroup field="trialRequest" opts={["Có, muốn thử trước", "Không cần thiết"]} data={data} set={set} />
      </div>
      <div className="fg">
        <label className="fl">Biết đến mình qua đâu?</label>
        <RadioGroup
          field="referralSource"
          opts={["Giới thiệu từ đối tác", "Facebook / Zalo", "Google", "TikTok", "Khác"]}
          data={data}
          set={set}
        />
      </div>
